-- Seed app-managed local notification templates into portal-side settings.
-- Mobile app reads this JSON from public.app_settings.key = 'notification_templates_v1'.
